            ...
            <div class="container">
                ...
                <div class="con-dis2">
                    <div class="payment-info">
                        ...
                        <!-- PRICE SUMMARY -->
                        <hr class="line">
                        <div class="d-popi"><span>Subtotal:</span><span class="d-block">${cartDTO.subtotal}</span></div>
                        <div class="d-popi"><span>VAT + Instructor Bonus:</span><span class="d-block">${cartDTO.tax}</span></div>
                        ...
                        <div class="d-popi"><strong>Total:</strong>
                            <strong class="d-block">${cartDTO.totalWithDiscount}</strong>
                        </div>
