...
<html>
    <head>
        ...
        <link rel="stylesheet" href="courseMaterial/AddQuiz.css"/>
        <script src="courseMaterial/AddQuizScript.js"></script>
    </head>
    <body>
        <jsp:include page="/component/header.jsp" />
        <div class="container-fluid">
            <div class="row">
                <form class="right-body col-md-8" action="add-lesson-item" id="quizForm" method="POST" enctype="multipart/form-data">
                    <div class="first-row">
                    ...
                    <div class="row">
                        <p class="col-md-2 quiz-title">Quizzes</p>
