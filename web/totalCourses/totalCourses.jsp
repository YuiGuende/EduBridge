                ...
                <table>
                    ...
                    <c:forEach var="course" items="${listCourse}">
                        <tr>
                            ...
                            <td><c:out value="${course.publishedTime}"/></td>
                            <td><c:out value="${course.lastUpdate}"/></td>
                            <td><c:out value="${course.status}"/></td>
                            <td>
                                <a href="courses?action=view&id=${course.id}" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-eye"></i> View
                                </a>
                                <a href="courses?action=edit&id=${course.id}" class="btn btn-outline-secondary btn-sm">
