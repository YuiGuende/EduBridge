...
public class Course extends ReportTarget {
    ...
    @Column(name = "thumbnail_url", length = 500, columnDefinition = "nvarchar(max)")
...
//    public Course(String title, String headline, String description, Language primaryLanguage, String thumbnailUrl, LocalDateTime publishedTime, int estimatedTime, LocalDateTime createdDate, LocalDateTime lastUpdate, String createdBy, String updatedBy, Rate rate, double price, double discountPrice, Long version, Long id) {
//        super(id);
//        this.title = title;
//        this.headline = headline;
//        this.description = description;
