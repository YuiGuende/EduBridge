...
public class CourseLearner implements Serializable {
    ...
    public CourseLearnerPK getCourseLearnerPK() { return courseLearnerPK; }

    public void setCourseLearnerPK(CourseLearnerPK courseLearnerPK) { this.courseLearnerPK = courseLearnerPK; }
    ...
    @Override
    public int hashCode() { return courseLearnerPK != null ? courseLearnerPK.hashCode() : 0; }

    @Override
    public boolean equals(Object object) {
        if (!(object instanceof CourseLearner)) return false;
